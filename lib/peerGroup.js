...
// TODO: remove bitcore-lib dependency so we don't have to hack around
// their weird one-instance policy
...
PeerGroup.prototype.connect = function (opts, cb) {
  ...
  if (this.wrtc) {
    tasks.push(function (cb) {
      async.each(self.webSeedUris, function (uri, cb) {
        var client = new PeerhubClient(uri, { wrtc: this.wrtc }, function () {
